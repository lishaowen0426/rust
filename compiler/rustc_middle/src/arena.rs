...
macro_rules! arena_types {
    ($macro:path) => (
        $macro!([
            ...
            [] miri_results: rustc_data_structures::unord::UnordMap< rustc_hir::def_id::DefId, rustc_data_structures::unord::UnordSet<rustc_middle::mir::Local>>,
            [] miri_raw_results: rustc_data_structures::unord::UnordMap<String , rustc_data_structures::unord::UnordMap<rustc_hir::def_id::LocalDefId, rustc_data_structures::unord::UnordSet<rustc_middle::mir::Local>>>,
