...
pub const INERT_ATTRIBUTES: &[BuiltinAttribute] = &[
    ...
    rustc_attr!(rustc_allocator_unsafe, Normal, template!(Word), WarnFollowing, IMPL_DETAIL),
    rustc_attr!(rustc_nounwind, Normal, template!(Word), WarnFollowing, IMPL_DETAIL),
    rustc_attr!(rustc_reallocator, Normal, template!(Word), WarnFollowing, IMPL_DETAIL),
    rustc_attr!(rustc_deallocator, Normal, template!(Word), WarnFollowing, IMPL_DETAIL),
    rustc_attr!(rustc_deallocator_unsafe, Normal, template!(Word), WarnFollowing, IMPL_DETAIL),
